...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'soft': '0 4px 20px -2px rgba(15, 39, 66, 0.08)',
        'card': '0 10px 40px -10px rgba(15, 39, 66, 0.15)',
        'cta': '0 10px 30px -5px rgba(249, 115, 22, 0.4)',
      },
      backgroundImage: {
        'hero-pattern': "linear-gradient(135deg, rgba(15, 39, 66, 0.92) 0%, rgba(31, 56, 86, 0.85) 100%)",
